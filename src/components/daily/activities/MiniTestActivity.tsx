...
export default function MiniTestActivity({ activity, onComplete }: MiniTestActivityProps) {
  ...
  const getOptions = (q: any) => {
    ...
    if (q.question_type === 'true_false' || q.question_type === 'tfng') {
      return [
      ...
      <div className="flex justify-end mt-6">
        {!submitted ? (
          <button
            ...
            className={`px-8 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all shadow-md ${
              !allAnswered
          ...
          <button
            ...
            className="px-8 py-3.5 bg-[#5D6B2D] hover:bg-[#46531F] text-[#FFF8EB] rounded-xl font-black text-xs uppercase tracking-wider transition-all shadow-md"
          >
